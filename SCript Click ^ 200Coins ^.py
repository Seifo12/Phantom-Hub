...
def JOK(text, delay, add_new_line=True):
    ...
    if add_new_line:
        print("\n", end="", flush=True)
output = render('JOKER&BRO', colors=['white', 'blue'], align='center')
print (output)
JOK(m+f"\033[1;32m\n      'https://t.me/KINGSNET70'      "+f"━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━", 0.07, True)
bot = 'UQB4SzNlmghDZANekn4Hrk99XzYu61gNpTrmxbDKsqjsbkQt'
acc = '5584231309'
...
def main():
    ...
    'timestamp': int(time.time()),
        ...
        if response.status_code == 200:
        	...
        	print(g+f' ➜ Done Add 200 coin✅ | {coin} BY: JOK&Hamo')
        	tlg = f"https://api.telegram.org/bot{bot}/sendMessage?chat_id={acc}&text=•  ➜ Done Add 200 coin✅ | {coin} BY: JOK&Hamo"
